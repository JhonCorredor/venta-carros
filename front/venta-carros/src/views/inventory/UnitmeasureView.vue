<template>
    <div class="container">
        <div class="card text-white bg-success mb-3" style="max-width: 20rem;">
            <div class="card-header">Registro Unidades de Medida</div>
        </div>
        <!--ENTRADA DE DATOS-->

        <div class="form-group">
            <label class="form-label mt-1">Nombre Unidad de Medida</label>
    ...
    created() {
     ...
     methods: {
        ...
        findById: function (id) {
            ...
            axios.get('http://132.145.204.101:8009/api/inventory/unitMeasure/' + id).then(result => {
        ...
        deleteById: function (id) {
            ...
            axios.delete('http://132.145.204.101:8009/api/inventory/unitMeasure/' + id).then(() => {
                Swal.fire({
                        icon: 'success',
        ...
        dataAdd: function () {
            ...
            axios.post('http://132.145.204.101:8009/api/inventory/unitMeasure', data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
        ...
        dataUpdate: function () {
            ...
            axios.put('http://132.145.204.101:8009/api/inventory/unitMeasure/' + this.id, data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
