<template>
    <div class="container">
        <div class="card text-white bg-success mb-3" style="max-width: 20rem;" color="white">
            <div class="card-header">Registro clientes</div>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-select" v-model="usuarioId">
                ...
                <option v-for="item in listUser" :key="item.id" :value="item.id">{{ item.usuario }}</option>
            </select>
...
export default {
    ...
    methods: {
        ...
        findByid: function (id) {
            ...
            axios.get('http://132.145.204.101:8009/api/client/' + id).then(result => {
        ...
        deleteById: function (id) {
            ...
            axios.delete('http://132.145.204.101:8009/api/client/' + id).then(() => {
                Swal.fire({
                    icon: 'success',
        ...
        dataAdd: function () {
            ...
            axios.post('http://132.145.204.101:8009/api/client', data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
        ...
        dataUpdate: function () {
            ...
            axios.put('http://132.145.204.101:8009/api/client/' + this.id, data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
                        title: "'El registro se guardó de forma correcta.'",
