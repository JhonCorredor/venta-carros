<template>
    <div class="container">
        <div class="card text-white bg-success mb-3" style="max-width: 20rem;">
            <div class="card-header">Permisos Usuarios Roles</div>
        </div>
...
export default {
    ...
    methods: {
        ...
        findByid: function (id) {
            ...
            axios.get('http://132.145.204.101:8009/api/userRole/' + id).then(result => {
        ...
        deleteById: function (id) {
            ...
            axios.delete('http://132.145.204.101:8009/api/userRole/' + id).then(() => {
                Swal.fire({
                    icon: 'success',
        ...
        dataAdd: function () {
            ...
            axios.post('http://132.145.204.101:8009/api/userRole', data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
        ...
        dataUpdate: function () {
            ...
            axios.put('http://132.145.204.101:8009/api/userRole/' + this.id, data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
                        title: "'El registro se guardó de forma correcta.'",
