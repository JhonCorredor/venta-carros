<template>
    <div class="container">
        <div class="card text-white bg-success mb-3" style="max-width: 20rem;">
            <div class="card-header">Registro de los permisos</div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" v-model="ruta" placeholder="Ingresar la ruta">
...
export default {
    ...
    methods: {
        ...
        findByid: function (id) {
            ...
            axios.get('http://132.145.204.101:8009/api/view/' + id).then(result => {
            ...
            if (bandera == true) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.delete('http://132.145.204.101:8009/api/view/' + id).then(() => {
                            Swal.fire({
                                icon: 'success',
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Error, registro tiene asociado un permiso a una vista.'
                })
            }
        },
        dataAdd: function () {
            ...
            axios.post('http://132.145.204.101:8009/api/view', data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
        ...
        dataUpdate: function () {
            ...
            axios.put('http://132.145.204.101:8009/api/view/' + this.id, data).then(result => {
                if (result.data) {
                    Swal.fire({
                        icon: 'success',
                        title: "'El registro se guardó de forma correcta.'",
