...
public class TiposVehiculosController {
	...
	@GetMapping("{id}")
	public Optional<TiposVehiculos> show(@PathVariable String id) {
	...
	@PutMapping("{id}")
	@ResponseStatus(code = HttpStatus.CREATED)
	public TiposVehiculos update(@PathVariable String id, @RequestBody TiposVehiculos tiposVehiculos) {
